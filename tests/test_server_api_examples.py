    ...
    def test_server_config_creation(self):
        ...
        server_config = ServerConfig(
            ...
            run_config=RunConfig(
                agent_registry={"MyAgent": agent}, model_provider=mock_provider, max_turns=5
            ),
        )
...
class TestChatRequestExamples:
    ...
    def test_chat_request_structure(self):
        ...
        chat_request = {
            ...
            "context": {"userId": "user-123", "permissions": ["user"]},
            "max_turns": 5,
    ...
    def test_message_format_validation(self):
        ...
        assistant_message = {"role": "assistant", "content": "Hello! How can I help you today?"}
...
class TestMemoryEndpointExamples:
    ...
    def test_conversation_response_format(self):
        ...
        conversation_response = {
            ...
            "data": {
                ...
                "metadata": {"session_start": "2024-01-15T10:00:00Z", "topic": "general_chat"},
            },
        }
    ...
    def test_conversation_not_found_error(self):
        ...
        error_response = {"success": False, "error": "Conversation user-123-session-1 not found"}
    ...
    def test_delete_conversation_response(self):
        ...
        delete_response = {
            "success": True,
            "data": {"conversation_id": "user-123-session-1", "deleted": True},
        }
    ...
    def test_memory_health_response(self):
        ...
        memory_health_response = {
            ...
            "data": {
                ...
                "latency_ms": 2.5,
                "details": {"connections": 5, "memory_usage": "15.2MB", "version": "7.0.0"},
            },
        }
...
class TestErrorHandlingExamples:
    ...
    def test_memory_not_configured_error(self):
        ...
        memory_error = {"success": False, "error": "Memory not configured for this server"}
...
class TestServerConfigurationExamples:
    ...
    def test_production_configuration(self):
        ...
        mock_env = {"PORT": "8000", "FRONTEND_URL": "https://myapp.com"}

        config = {
            "host": "0.0.0.0",
            "port": int(mock_env.get("PORT", "8000")),
            "cors": {"allow_origins": [mock_env.get("FRONTEND_URL")], "allow_credentials": True},
        }
...
class TestPerformanceExamples:
    ...
    def test_connection_pooling_config(self):
        ...
        limits_config = {"max_connections": 100, "max_keepalive_connections": 20}
        ...
        def validate_context(context: dict) -> dict:
            ...
            if "permissions" in safe_context:
                ...
                safe_context["permissions"] = [
                    p for p in safe_context["permissions"] if p in allowed_permissions
                ]
