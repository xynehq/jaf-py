...
from jaf.providers.mcp import create_mcp_stdio_tools, FastMCPTool
...
class TestMCPComprehensive:
    ...
    async def test_mcp_stdio_tool_creation(self):
        ...
        try:
            ...
            print(
                f"   ⚠️  MCP stdio tool creation failed (expected if server not available): {type(e).__name__}"
            )
    ...
    async def test_mcp_tool_execution(self):
        ...
        try:
            ...
            print(
                f"   ⚠️  MCP tool execution test failed (expected if server not available): {type(e).__name__}"
            )
