...
from jaf.a2a import (
    A2A, create_a2a_agent, create_a2a_tool, create_server_config,
    create_a2a_server, create_a2a_client, send_message_to_agent,
    discover_agents, check_a2a_health
)
...
class TestA2AConvenienceAPI:
    ...
    def test_a2a_constants(self):
        ...
        from jaf.a2a import (
            ...
            A2A_SUPPORTED_TRANSPORTS, A2A_DEFAULT_CAPABILITIES
        )
