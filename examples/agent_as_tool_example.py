...
def create_litellm_provider(config: Config):
    ...
    return make_litellm_provider(
        base_url=config.litellm_url, api_key=config.litellm_api_key, default_timeout=DEFAULT_TIMEOUT
    )
...
def create_spanish_agent(config: Config) -> Agent[TranslationContext, TranslationOutput]:
    ...
    return Agent(
        ...
        model_config=ModelConfig(
            name=config.litellm_model, temperature=DEFAULT_TEMPERATURE_TRANSLATION
        ),
    )
...
def create_orchestrator_agent(config: Config) -> Agent[TranslationContext, str]:
    ...
    return Agent(
        ...
        model_config=ModelConfig(
            name=config.litellm_model, temperature=DEFAULT_TEMPERATURE_ORCHESTRATOR
        ),
    )
...
async def demonstrate_agent_as_tool():
    ...
    initial_messages = [Message(role=ContentRole.USER, content="Hello, how are you?")]
    ...
    context_spanish_only = TranslationContext(
        user_id="demo_user", language_preference="spanish_only"
    )
    ...
    try:
        ...
        tool_messages = [
            msg for msg in result2.final_state.messages if msg.role == ContentRole.TOOL
        ]
...
async def start_server():
    ...
    print(
        '     -d \'{"messages":[{"role":"user","content":"Hello, how are you today?"}],"agent_name":"orchestrator_agent","context":{"user_id":"demo","language_preference":"french_spanish"}}\''
    )
    print("")
    ...
    print('     -H "Content-Type: application/json" \\')
    print(
        '     -d \'{"messages":[{"role":"user","content":"Good morning, how are you?"}],"agent_name":"orchestrator_agent","context":{"user_id":"demo","language_preference":"spanish_only"}}\''
    )
    print("")
    ...
    print('     -H "Content-Type: application/json" \\')
    print(
        '     -d \'{"messages":[{"role":"user","content":"I hope you have a wonderful day filled with joy and happiness!"}],"agent_name":"orchestrator_agent","context":{"user_id":"demo","language_preference":"french_spanish"}}\''
    )
    print("")
    ...
    print('     -H "Content-Type: application/json" \\')
    print(
        '     -d \'{"messages":[{"role":"user","content":"Thank you for your help"}],"context":{"user_id":"demo","language_preference":"french_spanish"}}\''
    )
    print("")
