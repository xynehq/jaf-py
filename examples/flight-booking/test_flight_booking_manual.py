    ...
    async def get_completion(self, state, agent, config):
        ...
        if self.scenario == "search_flights":
            ...
            if self.call_count == 1:
                        ...
                        "tool_calls": [
                            {
                                ...
                                "function": {
                                    ...
                                    "arguments": json.dumps(
                                        {"flight_number": "AA101", "class_preference": "economy"}
                                    ),
                                },
                            }
                        ],
                ...
                return {
                    "message": {"content": "Seat availability check completed.", "tool_calls": None}
                }
            ...
            if self.call_count == 1:
                        ...
                        "tool_calls": [
                            {
                                ...
                                "function": {
                                    ...
                                    "arguments": json.dumps({"flight_number": "AA101"}),
                                },
                            }
                        ],
                    }
                ...
                return {
                    "message": {"content": "Flight status check completed.", "tool_calls": None}
                }
            ...
            if self.call_count == 1:
                        ...
                        "tool_calls": [
                            {
                                ...
                                "function": {
                                    "name": "cancel_booking",
                                    "arguments": json.dumps({"booking_id": "ABC123"}),
                                },
                            }
                        ],
                    }
                ...
                return {
                    "message": {"content": "Booking cancellation completed.", "tool_calls": None}
                }
...
async def test_single_agent_flight_search():
    ...
    if tool_messages:
        ...
        print(
            f"   💰 Price Range: ${tool_result.get('price_range', {}).get('min', 0)} - ${tool_result.get('price_range', {}).get('max', 0)}"
        )
...
async def test_multi_agent_coordination():
    ...
    search_messages = [
        m for m in result.final_state.messages if m.role == "tool" and "flights" in m.content
    ]
    ...
    return (
        result.final_state.current_agent_name == "BookingSpecialist"
        and len(handoff_messages) >= 2
        and result.final_state.turn_count >= 3
    )
...
async def test_context_preservation():
    ...
    initial_context = {
        ...
        "session_data": {"search_history": ["LAX-JFK", "JFK-LAX"], "booking_count": 3},
    }
