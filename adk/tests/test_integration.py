...
from adk.runners.multi_agent import execute_multi_agent, select_best_agent, merge_parallel_responses
...
class TestSchemaIntegration:
    ...
    def test_complex_nested_schema_validation(self):
        ...
        # Valid complex data
        valid_data = {
            "user_profile": {"name": "John Doe", "email": "john.doe@example.com", "age": 30},
...
class TestMultiAgentIntegration:
    ...
    def test_intelligent_agent_selection_integration(self, test_agents):
        ...
        flight_message = Message(
            role="user", content="I need to find flights from LAX to JFK for next week"
        )
        ...
        booking_message = Message(
            role="user", content="I want to book flight AA123 and use my loyalty points"
        )
        ...
        weather_message = Message(
            role="user", content="What's the weather forecast for my destination?"
        )
        ...
        ambiguous_message = Message(role="user", content="Can you help me with my trip planning?")
    ...
    def test_metadata_based_agent_selection(self, test_agents):
        ...
        context = RunContext(
            user_id="test_user", preferences={"preferred_agents": ["BookingAgent"]}
        )

        # Test preference-based selection with explicit booking keywords
        booking_message = Message(role="user", content="I need help with booking and reservations")
        ...
        specific_message = Message(role="user", content="What's the weather like today?")
    ...
    def test_coordination_rules_integration(self, test_agents):
        ...
        # Test VIP rule
        vip_context = RunContext(user_id="vip_user", metadata={"vip_status": True})
        ...
        season_context = RunContext(user_id="regular_user", metadata={"travel_season": True})
        ...
        off_season_context = RunContext(user_id="regular_user", metadata={"travel_season": False})
    ...
    def test_response_merging_integration(self, test_agents):
        ...
        search_response = AgentResponse(
            content=Message(
                role="assistant",
                content="Found 3 flights: AA123 ($299), UA456 ($325), DL789 ($310)",
            ),
        ...
        weather_response = AgentResponse(
            content=Message(
                role="assistant",
                content="Weather in destination: 75°F, partly cloudy, good for travel",
            ),
...
class TestCompleteWorkflowIntegration:
    ...
    async def test_flight_booking_workflow_integration(self):
        ...
        message = Message(role="user", content="I need to find flights from LAX to JFK")
        ...
        booking_schema: JsonSchema = {
            "type": "object",
            "properties": {
                "flight_id": {"type": "string", "pattern": r"^[A-Z]{2}\d{3,4}$"},
                "passenger_details": {
                    "type": "array",
                    "items": {
                        "type": "object",
        ...
        booking_message = Message(role="user", content="I want to book flight AA123")
    ...
    def test_error_handling_integration(self):
        ...
        invalid_data = {"email": "not-an-email", "age": 200}
        ...
        config = MultiAgentConfig(delegation_strategy=DelegationStrategy.PARALLEL, sub_agents=[])
