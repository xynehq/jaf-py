...
class TestLLMInteractionHooks:
    ...
    async def test_on_before_llm_call_message_modification(self, base_config, test_message, test_context, mock_model_provider):
        ...
        callbacks.on_before_llm_call.return_value = {
    ...
    async def test_on_before_llm_call_skip_llm_call(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_on_after_llm_call_response_modification(self, base_config, test_message, test_context, mock_model_provider):
...
class TestIterationControlHooks:
    ...
    async def test_on_iteration_start_early_termination(self, base_config, test_message, test_context, mock_model_provider):
        """Test that on_iteration_start can terminate iteration early."""
        callbacks = MockCallbacks()
        
        # Configure to stop after first iteration
        callbacks.on_iteration_start.return_value = {
...
class TestCustomLogicInjection:
    ...
    async def test_on_check_synthesis_completion(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_on_query_rewrite_modifies_query(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_on_loop_detection_prevents_repetition(self, base_config, test_message, test_context, mock_model_provider):
...
class TestToolExecutionHooks:
    ...
    async def test_on_before_tool_execution_parameter_modification(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_on_after_tool_execution_result_modification(self, base_config, test_message, test_context, mock_model_provider):
...
class TestContextManagement:
    ...
    async def test_on_context_update_filters_context(self, base_config, test_message, test_context, mock_model_provider):
...
class TestBackwardCompatibility:
    ...
    async def test_execute_agent_without_callbacks(self, base_config, test_message, test_context, mock_model_provider):
        """Test that agent execution works normally when no callbacks are provided."""
        # Use config without callbacks
        result = await execute_agent(base_config, {}, test_message, test_context, mock_model_provider)
    ...
    async def test_run_agent_without_callbacks(self, base_config, test_message, test_context, mock_model_provider):
...
class TestErrorHandlingAndResilience:
    ...
    async def test_callback_error_does_not_break_execution(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_partial_callback_implementation(self, base_config, test_message, test_context, mock_model_provider):
...
class TestCallbackSystemIntegration:
    ...
    async def test_complete_iterative_workflow(self, base_config, test_message, test_context, mock_model_provider):
    ...
    async def test_callback_system_performance(self, base_config, test_message, test_context, mock_model_provider):
