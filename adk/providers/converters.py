...
class AdkTypeConverter:
    ...
    def adk_to_openai_message(adk_message: AdkMessage) -> Dict[str, Any]:
        ...
        openai_message = {"role": adk_message.role, "content": adk_message.content or ""}
    ...
    def messages_list_to_openai(messages: List[AdkMessage]) -> List[Dict[str, Any]]:
        ...
        return [AdkTypeConverter.adk_to_openai_message(msg) for msg in messages]
    ...
    def openai_messages_to_adk(openai_messages: List[Dict[str, Any]]) -> List[AdkMessage]:
        ...
        return [AdkTypeConverter.openai_to_adk_message(msg) for msg in openai_messages]
    ...
    @staticmethod
    def extract_tool_calls_from_openai_response(
